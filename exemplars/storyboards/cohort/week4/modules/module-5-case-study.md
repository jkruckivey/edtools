...
**Version:** 2.0.1 | **Last Updated:** 2026-02-05

### Version 2.0.1 Changes
- **UPDATED:** "actual portfolio/allocation" → "modeled portfolio/allocation" language for consistency with widget assumption disclosures
...
This analyzer is pre-loaded with Serena Williams' modeled portfolio allocation across all five revenue streams (estimated from public reporting). But here's your challenge: **Was her strategy optimal?**
...
**What you'll discover:**
- How Serena's modeled allocation compares to "typical" elite athletes (hint: she's not typical)
...
**Functionality:**
- Pre-loaded with Serena's modeled allocations (estimated from public sources)
